...
- CI 빌드에 약 4~8분 소요 (실측 v1.3.3: Test 1분 42초 · Build and Release 3분 52초) (Ubuntu/Windows test 매트릭스 → Windows-2025 cold cache → electron-builder NSIS 패키징 + Sigstore provenance attest). 릴리즈 생성 직후에는 설치 파일 미첨부 상태가 정상.
