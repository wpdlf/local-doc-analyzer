...
> 최신 기능 요약은 [README.ko.md](../README.ko.md)를, 버전별 변경 사항은 [GitHub Releases](https://github.com/wpdlf/local-doc-analyzer/releases)를 참고하세요.
...
## 문제 해결 — 버전별 수정 이력 포함 (구 README 원문)
...
## 보안 설계 — 버전별 수정 이력 포함 (구 README 원문)
